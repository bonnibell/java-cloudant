...
public abstract class CloudantClientHelper {
    ...
    public static String getReplicationSourceUrl(String dbName) {
        if (REP_SOURCE == null) {
            String sourceEnv = System.getenv("TEST_REPLICATION_SOURCE_URL");
            REP_SOURCE = (sourceEnv != null) ? sourceEnv : System.getProperty("test.replication.source.url", "https://clientlibs-test.cloudant.com/");
